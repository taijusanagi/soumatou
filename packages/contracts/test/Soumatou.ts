...
describe.only("Soumatou", function () {
  it("mint", async function () {
    ...
    await soumatou.mint(to, location, imageURI, modelURI, tokenURI);
    ...
    // await expect(await soumatou.tokenURI(expectedTokenId)).to.equal(tokenURI);
  });
});
